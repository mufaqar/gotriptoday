...
<div class="booking_details">
                        ...
                        <div class="step active p-4 shadow-sm border-0 mb-5">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="pax" min="1" max="14" class="form-control" required>
                                </div>
  ...
  <div class="form-check mb-4" id="premiumWrapper" style="display:none;">
    <input class="form-check-input" type="checkbox" id="premium_upgrade" name="premium_upgrade" value="1">
  ...
  <div class="mb-4">
    ...
    <div class="row g-2">
      <div class="col-md-4">
        <input type="number" class="form-control" name="baby_seat" min="0" max="5" value="0" placeholder="Baby Seat (0–3 yrs)">
      </div>
      <div class="col-md-4">
        <input type="number" class="form-control" name="toddler_seat" min="0" max="5" value="0" placeholder="Toddler Seat (3–6 yrs)">
      </div>
      <div class="col-md-4">
        <input type="number" class="form-control" name="booster_seat" min="0" max="5" value="0" placeholder="Booster (6+ yrs)">
      </div>
    </div>

    <div class="mt-3">
      <label for="extra_hours" class="form-label">Additional Hours</label>
      <input type="number" class="form-control" id="extra_hours" name="extra_hours" min="0" max="8" value="0">
    </div>
  </div>
  ...
  <div class="mb-4">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="passenger_mobile" name="passenger_mobile" required>
      <div class="invalid-feedback">Mobile/WhatsApp is required.</div>
    </div>

    <!-- Invoice Toggle -->
    <div class="form-check form-switch mb-3">
      <input class="form-check-input" type="checkbox" id="need_invoice" name="need_invoice">
    ...
    <div id="invoiceFields" style="display:none;">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control mb-2" id="invoice_street" name="invoice_street" placeholder="Street">
        <input type="text" class="form-control mb-2" id="invoice_city" name="invoice_city" placeholder="City">
        <input type="text" class="form-control mb-2" id="invoice_zip" name="invoice_zip" placeholder="ZIP">
        <input type="text" class="form-control" id="invoice_country" name="invoice_country" placeholder="Country">
  ...
  <div class="mb-4 p-3 border rounded bg-light">
    <h5>Total Price</h5>
    <p class="mb-0"><strong id="grand_total">€0.00</strong></p>
  </div>
