...
<div class="tour-details-header d-flex flex-lg-row flex-column gap-lg-4 align-items-start justify-content-between">
    <div class="col-12 col-lg-9">
        ...
        <?php if (!wp_is_mobile()): ?>
            <ul class="list-unstyled mb-3 d-flex flex-row gap-2 align-items-center text-black review_list"
    ...
    <div class="col-12 col-lg-3">
        <?php if (!wp_is_mobile()): ?>
            <ul class="list-unstyled d-flex flex-column gap-1 align-items-end text-black"
                style="font-size:14px; font-weight: 500;">
            ...
            <ul class="list-unstyled d-flex  justify-content-lg-end justify-content-start text-black mt-3"
                style="font-size:14px; font-weight: 500;">
